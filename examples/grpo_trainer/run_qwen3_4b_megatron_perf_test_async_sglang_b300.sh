#!/usr/bin/env bash
# Performance Test (Fully Async): Qwen3-4B | GRPO | Megatron + SGLang | 4×B300
#
# GPU: 2 train (TP2, DP1) + 2 inference (1 engine × TP2)
# B300 VRAM: no memory constraints — best params matching slime.
#
# Usage:
#   bash examples/grpo_trainer/run_qwen3_4b_megatron_perf_test_async_sglang_b300.sh
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_4b_grpo_n16_resp8192_megatron_async_sglang_b300}
