#!/usr/bin/env bash
# Performance Test (Fully Async 4096): Qwen3-4B | GRPO | Megatron + vLLM | 8×A100 40GB
#
# GPU allocation: 4 train (TP2, DP2) + 4 inference (2 engines × TP2)
# Matches slime: scripts/run-qwen3-4B-async-8gpu.sh
#
# Usage:
#   bash examples/grpo_trainer/run_qwen3_4b_megatron_perf_test_async_40g.sh
#
# Override env vars:
...
# 16 steps × 8 samples/step = 256 total
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_4b_grpo_n16_resp4096_megatron_async_4096_4tp2_4tp2}
